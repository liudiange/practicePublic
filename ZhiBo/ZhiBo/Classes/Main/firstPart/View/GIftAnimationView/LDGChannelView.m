...
- (void)addCacheNumber{
    self.lableCount += 1;
    if (self.currentState == CurrentStateWillEndAnimation) {
        [NSObject cancelPreviousPerformRequestsWithTarget:self selector:@selector(finishAnimation) object:nil];
...
- (void)finishAnimation{
    ...
    self.currentState = CurrentStateHaveEndAnimation;
    [UIView animateWithDuration:0.25 animations:^{
